...
namespace BharatEpaisaApp.Database
{
    public class DatabaseContext : IAsyncDisposable
    {
        private const string DbName = "BharatEpaisaApp.db3";
        ...
        public async Task<int> DeleteAllAsync<TTable>() where TTable : class, new()
        {
            return await Database.DeleteAllAsync<TTable>();
        }
